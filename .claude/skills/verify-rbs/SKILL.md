...
description: >-
  ...
  (the ~88-assertion runTests() suite plus a three-mode smoke and a console-error
...
1. **`runTests()` reports `88 / 88 passed`** (or `N / N` — every group green). This
...
- Tests:   88 / 88 passed   (or list each FAIL line)
