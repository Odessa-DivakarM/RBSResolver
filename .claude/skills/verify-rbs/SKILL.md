...
description: >-
  ...
  (the ~73-assertion runTests() suite plus a three-mode smoke and a console-error
...
1. **`runTests()` reports `73 / 73 passed`** (or `N / N` — every group green). This
...
- Tests:   73 / 73 passed   (or list each FAIL line)
