...
description: >-
  ...
  (the ~69-assertion runTests() suite plus a three-mode smoke and a console-error
...
1. **`runTests()` reports `69 / 69 passed`** (or `N / N` — every group green). This
...
- Tests:   69 / 69 passed   (or list each FAIL line)
