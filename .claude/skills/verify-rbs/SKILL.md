...
description: >-
  ...
  (the ~94-assertion runTests() suite plus a three-mode smoke and a console-error
...
1. **`runTests()` reports `94 / 94 passed`** (or `N / N` — every group green). This
...
- Tests:   94 / 94 passed   (or list each FAIL line)
